...
class Eric_method():
    ...
    def run(self, algorithms = ["Adaboost", "DecisionTree", "NaiveBayes", "GaussianProcess", "kNN", "MLP", "RF", "SVM"]):
...
if __name__ == "__main__" :
    ...
    # dataset = "australian"
    # base_model = "RF"
    # experimentID = "trial07"
    # fname_train = f"../dataset/{dataset}/a0_7_{dataset}-10tra.dat"
    # fname_test = f"../dataset/{dataset}/a0_7_{dataset}-10tst.dat"
