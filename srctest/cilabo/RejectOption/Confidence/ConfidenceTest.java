package cilabo.RejectOption.Confidence;
...
;
		...
		double expected =  confidence.confidence(ruleBasedClassifier, train.getPattern(0).getInputVector());

		double diff = 0.0001;

		assertEquals(expected, 0.7403483, diff);
	}
}
