...
public class MichiganHeuristicCrossover implements CrossoverOperator<IntegerSolution> {
	private double crossoverProbability;
	private RandomGenerator<Double> crossoverRandomGenerator;
	BoundedRandomGenerator<Integer> selectRandomGenerator;

	PatternBaseRuleGeneration heuristicRuleGeneration;

	Knowledge knowledge;
	ConsequentFactory consequentFactory;

	/** Constructor */
	public MichiganHeuristicCrossover(double crossoverProbability,
	...
	/** Constructor */
	public MichiganHeuristicCrossover(
	...
	public List<IntegerSolution> doCrossover(double probability, IntegerSolution _parent) {
		...
		if(numberOfHeuristic > 0) {
			...
			for(int i = 0; i < erroredPatternsIdx.length; i++) {
				...
				Antecedent generatedAntecedent = heuristicRuleGeneration.ruleGenerate(pattern);
